...
class MainMethodExe022 {
	...
	public static void main(String[] args) {
		...
		/*String str1 = new String("This is a BeginnersBook tutorial");
	       ...
	       System.out.println("Index of harcoded string: "+str1.indexOf("ok",22));
...
class BBBB extends MainMethodExe022{
	@Override
	 long getValue() {
